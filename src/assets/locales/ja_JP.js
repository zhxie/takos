const ja_JP = {
  ...
  'app.alert.info.use_automatic_cookie_generation':
    '再ログイン、アカウントの切り替え、自動クッキー生成の使用を希望する場合は、ブラウザで <a>Nintendo アカウント</a>を開いてログインし、「この人を選択」を右クリックして、リンクアドレスをコピーし、下のテキストボックスに貼り付けてから「クッキーを更新する」。',
  'app.alert.info.use_automatic_cookie_generation_first_time':
    '自動クッキー生成を使用しておらず、使用したい場合は、ブラウザで <a>Nintendo アカウント</a>を開いてログインし、「この人を選択」を右クリックして、リンクアドレスをコピーし、下のテキストボックスに貼り付けてから「クッキーを更新する」。',
  // App.modal
